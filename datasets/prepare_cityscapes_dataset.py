...
if __name__ == '__main__':
    ...
    parser.add_argument('--gtFine_dir', type=str, default='',
                        help='Path to the Cityscapes gtFine directory.')
    parser.add_argument('--leftImg8bit_dir', type=str, default='',
                        help='Path to the Cityscapes leftImg8bit_trainvaltest directory.')
    parser.add_argument('--output_dir', type=str, required=True,
                        default='./datasets/cityscapes',
                        help='Directory the output images will be written to.')
    opt = parser.parse_args()
    # opt.gtFine_dir="/media/cvlab/data/dataset/cityscapes/gtFine"
    # opt.leftImg8bit_dir="/media/cvlab/data/dataset/cityscapes/leftImg8bit"
    # opt.output_dir="./datasets/cityscapes/"
